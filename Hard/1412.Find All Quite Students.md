...
FROM Student JOIN Exam using (student_id)
)
...
SELECT student_id
FROM T
WHERE r1 = 1 OR r2 = 1 AND student_id IS NOT NULL
)

#SOLUTION 2 HANDLES NULL EFFICIENTLY
...
HAVING SUM(CASE WHEN r1 = 1 THEN 1 ELSE 0 END) = 0 AND SUM(CASE WHEN r2 = 1 THEB 1 ELSE 0 END)
```
