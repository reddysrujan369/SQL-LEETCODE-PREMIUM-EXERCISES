...
WITH T AS(
   SELECT YEAR(transaction_date) AS 'year',
          ...
          LAG(SUM(spend),1) OVER(PARTITION BY product_id ORDER BY YEAR(transaction_date) ASC) AS previous_year_spend
   ...
   SELECT year,
          ...
          current_year_spend,
          previous_year_spend,
          ROUND((-previous_year_spend+current_year_spend)/previous_year_spend * 100,2) AS yoy_rate
   FROM T
